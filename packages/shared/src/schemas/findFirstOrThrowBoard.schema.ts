...
export const BoardFindFirstOrThrowSelectSchema: z.ZodType<Prisma.BoardSelect> = z.object({
...
export const BoardFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    slug: z.boolean().optional(),
    logo: z.boolean().optional(),
...
export const BoardFindFirstOrThrowSchema: z.ZodType<Prisma.BoardFindFirstOrThrowArgs> = z.object({ select: BoardFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BoardIncludeObjectSchema.optional()), orderBy: z.union([BoardOrderByWithRelationInputObjectSchema, BoardOrderByWithRelationInputObjectSchema.array()]).optional(), where: BoardWhereInputObjectSchema.optional(), cursor: BoardWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BoardScalarFieldEnumSchema, BoardScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BoardFindFirstOrThrowArgs>;

export const BoardFindFirstOrThrowZodSchema = z.object({ select: BoardFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BoardIncludeObjectSchema.optional()), orderBy: z.union([BoardOrderByWithRelationInputObjectSchema, BoardOrderByWithRelationInputObjectSchema.array()]).optional(), where: BoardWhereInputObjectSchema.optional(), cursor: BoardWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BoardScalarFieldEnumSchema, BoardScalarFieldEnumSchema.array()]).optional() }).strict();