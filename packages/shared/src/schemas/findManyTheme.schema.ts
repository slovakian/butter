...
export const ThemeFindManySelectSchema: z.ZodType<Prisma.ThemeSelect> = z.object({
...
export const ThemeFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    isDark: z.boolean().optional(),
    variables: z.boolean().optional(),
...
export const ThemeFindManySchema: z.ZodType<Prisma.ThemeFindManyArgs> = z.object({ select: ThemeFindManySelectSchema.optional(), include: z.lazy(() => ThemeIncludeObjectSchema.optional()), orderBy: z.union([ThemeOrderByWithRelationInputObjectSchema, ThemeOrderByWithRelationInputObjectSchema.array()]).optional(), where: ThemeWhereInputObjectSchema.optional(), cursor: ThemeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ThemeScalarFieldEnumSchema, ThemeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ThemeFindManyArgs>;

export const ThemeFindManyZodSchema = z.object({ select: ThemeFindManySelectSchema.optional(), include: z.lazy(() => ThemeIncludeObjectSchema.optional()), orderBy: z.union([ThemeOrderByWithRelationInputObjectSchema, ThemeOrderByWithRelationInputObjectSchema.array()]).optional(), where: ThemeWhereInputObjectSchema.optional(), cursor: ThemeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ThemeScalarFieldEnumSchema, ThemeScalarFieldEnumSchema.array()]).optional() }).strict();