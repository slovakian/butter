...
export const MemberFindManySelectSchema: z.ZodType<Prisma.MemberSelect> = z
	.object({
...
export const MemberFindManySelectZodSchema = z
	.object({
		id: z.boolean().optional(),
		boardId: z.boolean().optional(),
		board: z.boolean().optional(),
...
export const MemberFindManySchema: z.ZodType<Prisma.MemberFindManyArgs> = z
	.object({
		select: MemberFindManySelectSchema.optional(),
	...
	.strict() as unknown as z.ZodType<Prisma.MemberFindManyArgs>;

export const MemberFindManyZodSchema = z
	.object({
		select: MemberFindManySelectSchema.optional(),
		include: z.lazy(() => MemberIncludeObjectSchema.optional()),
		orderBy: z
