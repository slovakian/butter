...
export const ChatroomFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ChatroomSelect> =
	z
		.object({
...
export const ChatroomFindFirstOrThrowSelectZodSchema = z
	.object({
		id: z.boolean().optional(),
		name: z.boolean().optional(),
		slug: z.boolean().optional(),
...
export const ChatroomFindFirstOrThrowSchema: z.ZodType<Prisma.ChatroomFindFirstOrThrowArgs> =
	z
		.object({
			select: ChatroomFindFirstOrThrowSelectSchema.optional(),
		...
		.strict() as unknown as z.ZodType<Prisma.ChatroomFindFirstOrThrowArgs>;

export const ChatroomFindFirstOrThrowZodSchema = z
	.object({
		select: ChatroomFindFirstOrThrowSelectSchema.optional(),
		include: z.lazy(() => ChatroomIncludeObjectSchema.optional()),
		orderBy: z
