...
export const ThemeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ThemeSelect> =
	z
		.object({
...
export const ThemeFindFirstOrThrowSelectZodSchema = z
	.object({
		id: z.boolean().optional(),
		name: z.boolean().optional(),
		isDark: z.boolean().optional(),
...
export const ThemeFindFirstOrThrowSchema: z.ZodType<Prisma.ThemeFindFirstOrThrowArgs> =
	z
		.object({
			select: ThemeFindFirstOrThrowSelectSchema.optional(),
		...
		.strict() as unknown as z.ZodType<Prisma.ThemeFindFirstOrThrowArgs>;

export const ThemeFindFirstOrThrowZodSchema = z
	.object({
		select: ThemeFindFirstOrThrowSelectSchema.optional(),
		include: z.lazy(() => ThemeIncludeObjectSchema.optional()),
		orderBy: z
