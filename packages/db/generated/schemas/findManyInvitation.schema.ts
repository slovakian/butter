...
export const InvitationFindManySelectSchema: z.ZodType<Prisma.InvitationSelect> =
	z
		.object({
...
export const InvitationFindManySelectZodSchema = z
	.object({
		id: z.boolean().optional(),
		boardId: z.boolean().optional(),
		board: z.boolean().optional(),
...
export const InvitationFindManySchema: z.ZodType<Prisma.InvitationFindManyArgs> =
	z
		.object({
			select: InvitationFindManySelectSchema.optional(),
		...
		.strict() as unknown as z.ZodType<Prisma.InvitationFindManyArgs>;

export const InvitationFindManyZodSchema = z
	.object({
		select: InvitationFindManySelectSchema.optional(),
		include: z.lazy(() => InvitationIncludeObjectSchema.optional()),
		orderBy: z
