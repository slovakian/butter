...
export const ChatroomFindFirstSelectSchema: z.ZodType<Prisma.ChatroomSelect> = z
	.object({
...
export const ChatroomFindFirstSelectZodSchema = z
	.object({
		id: z.boolean().optional(),
		name: z.boolean().optional(),
		slug: z.boolean().optional(),
...
export const ChatroomFindFirstSchema: z.ZodType<Prisma.ChatroomFindFirstArgs> =
	z
		.object({
			select: ChatroomFindFirstSelectSchema.optional(),
		...
		.strict() as unknown as z.ZodType<Prisma.ChatroomFindFirstArgs>;

export const ChatroomFindFirstZodSchema = z
	.object({
		select: ChatroomFindFirstSelectSchema.optional(),
		include: z.lazy(() => ChatroomIncludeObjectSchema.optional()),
		orderBy: z
