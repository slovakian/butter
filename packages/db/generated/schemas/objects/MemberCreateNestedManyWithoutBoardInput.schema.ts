...
const makeSchema = () =>
	z
		...
		.strict();
export const MemberCreateNestedManyWithoutBoardInputObjectSchema: z.ZodType<Prisma.MemberCreateNestedManyWithoutBoardInput> =
	makeSchema() as unknown as z.ZodType<Prisma.MemberCreateNestedManyWithoutBoardInput>;
export const MemberCreateNestedManyWithoutBoardInputObjectZodSchema =
	makeSchema();
