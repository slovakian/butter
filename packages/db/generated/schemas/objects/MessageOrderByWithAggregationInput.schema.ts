	...
	z
		.object({
			...
			_count: z
				...
				.optional(),
			_avg: z
				.lazy(() => MessageAvgOrderByAggregateInputObjectSchema)
				.optional(),
			_max: z
				.lazy(() => MessageMaxOrderByAggregateInputObjectSchema)
				.optional(),
			_min: z
				.lazy(() => MessageMinOrderByAggregateInputObjectSchema)
				.optional(),
			_sum: z
				.lazy(() => MessageSumOrderByAggregateInputObjectSchema)
				.optional(),
		})
		.strict();
export const MessageOrderByWithAggregationInputObjectSchema: z.ZodType<Prisma.MessageOrderByWithAggregationInput> =
	makeSchema() as unknown as z.ZodType<Prisma.MessageOrderByWithAggregationInput>;
