...
const makeSchema = () =>
	z
		...
		.strict();
export const BoardScalarRelationFilterObjectSchema: z.ZodType<Prisma.BoardScalarRelationFilter> =
	makeSchema() as unknown as z.ZodType<Prisma.BoardScalarRelationFilter>;
