...
export const BoardCountOutputTypeCountInvitationsArgsObjectSchema = makeSchema();
export const BoardCountOutputTypeCountInvitationsArgsObjectZodSchema = makeSchema();
