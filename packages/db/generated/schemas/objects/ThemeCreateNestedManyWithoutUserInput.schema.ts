...
const makeSchema = () =>
	z
		...
		.strict();
export const ThemeCreateNestedManyWithoutUserInputObjectSchema: z.ZodType<Prisma.ThemeCreateNestedManyWithoutUserInput> =
	makeSchema() as unknown as z.ZodType<Prisma.ThemeCreateNestedManyWithoutUserInput>;
export const ThemeCreateNestedManyWithoutUserInputObjectZodSchema =
	makeSchema();
