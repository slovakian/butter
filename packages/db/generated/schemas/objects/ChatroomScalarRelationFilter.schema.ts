...
const makeSchema = () =>
	z
		...
		.strict();
export const ChatroomScalarRelationFilterObjectSchema: z.ZodType<Prisma.ChatroomScalarRelationFilter> =
	makeSchema() as unknown as z.ZodType<Prisma.ChatroomScalarRelationFilter>;
