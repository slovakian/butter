...
const makeSchema = () =>
	z
		...
		.strict();
export const MessageCreateNestedManyWithoutUserInputObjectSchema: z.ZodType<Prisma.MessageCreateNestedManyWithoutUserInput> =
	makeSchema() as unknown as z.ZodType<Prisma.MessageCreateNestedManyWithoutUserInput>;
export const MessageCreateNestedManyWithoutUserInputObjectZodSchema =
	makeSchema();
