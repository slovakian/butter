...
const makeSchema = () =>
	z
		...
		.strict();
export const InvitationCreateNestedManyWithoutUserInputObjectSchema: z.ZodType<Prisma.InvitationCreateNestedManyWithoutUserInput> =
	makeSchema() as unknown as z.ZodType<Prisma.InvitationCreateNestedManyWithoutUserInput>;
export const InvitationCreateNestedManyWithoutUserInputObjectZodSchema =
	makeSchema();
