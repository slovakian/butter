...
const makeSchema = () =>
	z
		...
		.strict();
export const ChatroomListRelationFilterObjectSchema: z.ZodType<Prisma.ChatroomListRelationFilter> =
	makeSchema() as unknown as z.ZodType<Prisma.ChatroomListRelationFilter>;
