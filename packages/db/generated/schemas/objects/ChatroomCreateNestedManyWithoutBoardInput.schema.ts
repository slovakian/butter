...
const makeSchema = () =>
	z
		...
		.strict();
export const ChatroomCreateNestedManyWithoutBoardInputObjectSchema: z.ZodType<Prisma.ChatroomCreateNestedManyWithoutBoardInput> =
	makeSchema() as unknown as z.ZodType<Prisma.ChatroomCreateNestedManyWithoutBoardInput>;
export const ChatroomCreateNestedManyWithoutBoardInputObjectZodSchema =
	makeSchema();
