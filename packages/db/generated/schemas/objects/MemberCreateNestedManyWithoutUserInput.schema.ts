...
const makeSchema = () =>
	z
		...
		.strict();
export const MemberCreateNestedManyWithoutUserInputObjectSchema: z.ZodType<Prisma.MemberCreateNestedManyWithoutUserInput> =
	makeSchema() as unknown as z.ZodType<Prisma.MemberCreateNestedManyWithoutUserInput>;
export const MemberCreateNestedManyWithoutUserInputObjectZodSchema =
	makeSchema();
