...
import { VerificationAvgOrderByAggregateInputObjectSchema } from "./VerificationAvgOrderByAggregateInput.schema";
...
import { VerificationSumOrderByAggregateInputObjectSchema } from "./VerificationSumOrderByAggregateInput.schema";
	...
	z
		.object({
			...
			_count: z
				...
				.optional(),
			_avg: z
				.lazy(() => VerificationAvgOrderByAggregateInputObjectSchema)
				.optional(),
			_max: z
			...
			_min: z
				...
				.optional(),
			_sum: z
				.lazy(() => VerificationSumOrderByAggregateInputObjectSchema)
				.optional(),
		})
		.strict();
