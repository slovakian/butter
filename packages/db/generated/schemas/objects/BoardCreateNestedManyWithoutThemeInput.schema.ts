...
const makeSchema = () =>
	z
		...
		.strict();
export const BoardCreateNestedManyWithoutThemeInputObjectSchema: z.ZodType<Prisma.BoardCreateNestedManyWithoutThemeInput> =
	makeSchema() as unknown as z.ZodType<Prisma.BoardCreateNestedManyWithoutThemeInput>;
export const BoardCreateNestedManyWithoutThemeInputObjectZodSchema =
	makeSchema();
