...
export const BoardFindManySelectSchema: z.ZodType<Prisma.BoardSelect> = z
	.object({
...
export const BoardFindManySelectZodSchema = z
	.object({
		id: z.boolean().optional(),
		name: z.boolean().optional(),
		slug: z.boolean().optional(),
...
export const BoardFindManySchema: z.ZodType<Prisma.BoardFindManyArgs> = z
	.object({
		select: BoardFindManySelectSchema.optional(),
	...
	.strict() as unknown as z.ZodType<Prisma.BoardFindManyArgs>;

export const BoardFindManyZodSchema = z
	.object({
		select: BoardFindManySelectSchema.optional(),
		include: z.lazy(() => BoardIncludeObjectSchema.optional()),
		orderBy: z
