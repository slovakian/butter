...
export const ThemeFindUniqueSchema: z.ZodType<Prisma.ThemeFindUniqueArgs> = z
	.object({
		select: ThemeSelectObjectSchema.optional(),
		include: ThemeIncludeObjectSchema.optional(),
		where: ThemeWhereUniqueInputObjectSchema,
	})
	.strict() as unknown as z.ZodType<Prisma.ThemeFindUniqueArgs>;

export const ThemeFindUniqueZodSchema = z
	.object({
		select: ThemeSelectObjectSchema.optional(),
		include: ThemeIncludeObjectSchema.optional(),
		where: ThemeWhereUniqueInputObjectSchema,
