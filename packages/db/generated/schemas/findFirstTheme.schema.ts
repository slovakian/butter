...
export const ThemeFindFirstSelectSchema: z.ZodType<Prisma.ThemeSelect> = z.object({
...
export const ThemeFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    isDark: z.boolean().optional(),
    variables: z.boolean().optional(),
...
export const ThemeFindFirstSchema: z.ZodType<Prisma.ThemeFindFirstArgs> = z.object({ select: ThemeFindFirstSelectSchema.optional(), include: z.lazy(() => ThemeIncludeObjectSchema.optional()), orderBy: z.union([ThemeOrderByWithRelationInputObjectSchema, ThemeOrderByWithRelationInputObjectSchema.array()]).optional(), where: ThemeWhereInputObjectSchema.optional(), cursor: ThemeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ThemeScalarFieldEnumSchema, ThemeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ThemeFindFirstArgs>;

export const ThemeFindFirstZodSchema = z.object({ select: ThemeFindFirstSelectSchema.optional(), include: z.lazy(() => ThemeIncludeObjectSchema.optional()), orderBy: z.union([ThemeOrderByWithRelationInputObjectSchema, ThemeOrderByWithRelationInputObjectSchema.array()]).optional(), where: ThemeWhereInputObjectSchema.optional(), cursor: ThemeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ThemeScalarFieldEnumSchema, ThemeScalarFieldEnumSchema.array()]).optional() }).strict();